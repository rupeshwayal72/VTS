...
public class viewQuotesTest2 extends TestUtil {

	carInsurance carInsurance;

	public viewQuotesTest2() {
	...
	@Test
	public void viewQuoteTest2() throws InterruptedException, IOException {
		try {
			...
			carInsurance.selectPolicyExpiry("Not Expired", "Yes", "Yes");
